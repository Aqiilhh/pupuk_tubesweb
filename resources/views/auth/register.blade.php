        ...
        <div class="authentication-inner">
            ...
            <p class="mb-4">Silahkan daftarkan akun anda</p>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="no_telepon" name="no_telepon" placeholder="masukan no telepon anda" />
                </div>
                <div class="mb-3">
                    <label for="jenis_kelamin" class="form-label" style="margin-right: 5px">Jenis kelamin</label>
                        <input
